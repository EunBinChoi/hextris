================================================================================
    MFC 라이브러리 : p.210_5 프로젝트 개요
================================================================================

응용 프로그램 마법사에서 이 p.210_5 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 
프로그램작성을 위한 기본 구조를 제공합니다.

이 파일에는 p.210_5 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
p.210_5.h
    ...
    헤더(Resource.h 포함)가 들어 있고 Cp210_5App 응용 프로그램
    클래스를 선언합니다.

p.210_5.cpp
    응용 프로그램 클래스 Cp210_5App이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\p.210_5.ico
    ...
    주 리소스 파일인 p.210_5.rc에 의해 포함됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 p.210_5.pch와
