...
void CChildView::OnPaint() 
{
	...
	{
		dc.StretchBlt(350+bmpinfo.bmWidth-1, 10+bmpinfo.bmHeight-1, -bmpinfo.bmWidth, -bmpinfo.bmHeight, 
			&dcmem, 0, 0, bmpinfo.bmWidth, bmpinfo.bmHeight, SRCCOPY);
	}
}

void CChildView::OnLButtonUp(UINT nFlags, CPoint point) 	//<= [a15]
{
