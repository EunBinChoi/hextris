...
void CChildView::OnPaint() 
{
	...
	CFont font1, font2, font3;	//<= [a08]
	font1.CreatePointFont( 120, _T("굴림") );
	font2.CreatePointFont( 120, _T("궁서") );
	font3.CreatePointFont( 120, _T("바탕") );
	...
	dc.SelectObject( &font1 );	//<= [a08]
	dc.DrawText(CString("DrawText 함수를 연습합니다. [1]"), &rect, 0);

	dc.SelectObject( &font2 );	//<= [a08]
