                         ...
                         WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		return 0;
	case WM_LBUTTONDOWN:
		MessageBox(hwnd, TEXT("마우스 클릭!"), TEXT("마우스 메시지"), MB_OKCANCEL );

		/*버튼 스타이
		MB_OK  : OK
		MB_OKCANCEL : 확인 취소
		MB_YESNO : 예 아니오
		MB_ABORTRETRYIGNORE : 중단 다시시도 무시
		MB_RETRYCANCEL : 다시시도 취소
		MB_CANCELTRYCONTINUE :ㅇ 에러
		MB_CONTINUEABORT Errorend*/
		return 0;
	case WM_PAINT:
