...
BOOL CChildView::PreCreateWindow(CREATESTRUCT& cs) 
{
	...
	cs.lpszClass = AfxRegisterWndClass(CS_HREDRAW|CS_VREDRAW|CS_DBLCLKS, 
		::LoadCursor(NULL, IDC_ARROW), NULL, NULL); // NULL 배경 브러시
...
void CChildView::OnPaint() 
{
	...
	dc.SelectStockObject( ANSI_FIXED_FONT );	//<= [a13]
	dc.TextOut( 100, 150, _T("타원(Ellipse)") );
	...
	dc.SelectStockObject( ANSI_VAR_FONT );	//<= [a13]
	dc.TextOut( 280, 150, _T("사각형(Tetragon)") );
}
